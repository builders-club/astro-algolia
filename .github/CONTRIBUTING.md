...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/astro-algolia.git

Push to your fork and [submit a pull request](https://github.com/builders-club/astro-algolia/compare/) against the `main` branch.
